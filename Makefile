...
DOCKER_IMAGE_TAG=$(REPO)/$(DAPR_SYSTEM_IMAGE_NAME):$(DAPR_VERSION)
DAPR_RUNTIME_DOCKER_IMAGE_TAG=$(REPO)/$(DAPR_RUNTIME_IMAGE_NAME):$(DAPR_VERSION)
DAPR_PLACEMENT_DOCKER_IMAGE_TAG=$(REPO)/$(DAPR_PLACEMENT_IMAGE_NAME):$(DAPR_VERSION)
DAPR_SENTRY_DOCKER_IMAGE_TAG=$(REPO)/$(DAPR_SENTRY_IMAGE_NAME):$(DAPR_VERSION)
